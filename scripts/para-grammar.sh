...
KEY=para-grammar
rawfile_key=para-grammar                                  # name identifier for raw data in the format "train.${rawfile_key}.en"
...
REF_L2_DIR=/export/c11/sli136/l2mt/en-es/data/raw
...
#     ${REF_L2_DIR}/test.l2.en \
#     ${REF_L2_DIR}/test.l2.es \
#     ${REF_L2_DIR}/test.ref.en \
#     ${REF_L2_DIR}/test.ref.es \
#     --encode-dest \
