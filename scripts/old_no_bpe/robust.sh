...
DATA_BIN=${DATA_DIR}'/drop_bin'
src='en'
tgt='es'

fairseq-preprocess --source-lang $src --target-lang $tgt \
    --srcdict /home/sli136/l2mt/input_data/data_bin/dict.en.txt \
    --tgtdict /home/sli136/l2mt/input_data/data_bin/dict.es.txt \
    --trainpref /home/sli136/l2mt/input_data/retrieved_drop/train.mixed_drop \
    --validpref /home/sli136/l2mt/input_data/retrieved_drop/dev.mixed_drop \
    --testpref /home/sli136/l2mt/input_data/retrieved_drop/test.mixed_drop \
    --destdir ${DATA_BIN} \
    --workers 20
...
FFN_DIM=2048
HEADS=4
SAVE_PATH='/export/c11/sli136/l2mt/robust'
...
fairseq-train ${DATA_BIN} --arch ${ARCH}  --task translation \
 ...
 --optimizer adam --log-file ${LOG_FILE} --max-epoch ${MAX_EPOCH} --scoring bleu --batch-size 128 \
