...
#     --validpref /home/sli136/l2mt/nmt-grammar-noise/en-es-experiments/valid.clean \
#     --testpref /home/sli136/l2mt/nmt-grammar-noise/en-es-experiments/test.clean \
#     --joined-dictionary \
#     --destdir ${DATA_BIN} \
#     --workers 20
...
FFN_DIM=2048
HEADS=4
SAVE_PATH='/export/c11/sli136/l2mt/reproduce'
...
fairseq-train ${DATA_BIN} --arch ${ARCH}  --task translation \
 ...
 --warmup-init-lr 1e-03 --warmup-updates 24000 --lr 0.0004 --stop-min-lr 1e-04 --clip-norm 0.0 --dropout 0.8 --weight-decay 0.0 --criterion label_smoothed_cross_entropy \
 ...
 --optimizer adam --log-file ${LOG_FILE} --scoring bleu\
