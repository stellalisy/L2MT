...
DATA_DIR='/home/sli136/l2mt/input_data_mixed'
DATA_BIN=${DATA_DIR}'/base_bin'
REF_BIN=${DATA_DIR}'/ref_bin'
L2_BIN=${DATA_DIR}'/l2_bin'

SAVE_PATH='/export/c11/sli136/l2mt/mixed_bpe'
src='en'
tgt='es'
...
#     --trainpref ${DATA_BIN}/train.mixed.bpe \
#     --validpref ${DATA_BIN}/dev.mixed.bpe \
#     --testpref ${DATA_BIN}/test.mixed.bpe \
#     --bpe sentencepiece \
#     --destdir ${DATA_BIN} \
#     --joined-dictionary \
#     --workers 20
...
# echo "" > ${REF_BIN}/train.ref.bpe.en
# echo "" > ${REF_BIN}/train.ref.bpe.es
# echo "" > ${REF_BIN}/dev.ref.bpe.en
# echo "" > ${REF_BIN}/dev.ref.bpe.es
# fairseq-preprocess --source-lang $src --target-lang $tgt \
#     --trainpref ${REF_BIN}/train.ref.bpe \
...
# echo "" > ${L2_BIN}/train.l2.bpe.en
# echo "" > ${L2_BIN}/train.l2.bpe.es
# echo "" > ${L2_BIN}/dev.l2.bpe.en
# echo "" > ${L2_BIN}/dev.l2.bpe.es
# fairseq-preprocess --source-lang $src --target-lang $tgt \
#     --trainpref ${L2_BIN}/train.l2.bpe \
