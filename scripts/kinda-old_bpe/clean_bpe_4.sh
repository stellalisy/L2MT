...
#     --trainpref ${BPE_DIR}/train.clean.bpe \
#     --validpref ${BPE_DIR}/dev.clean.bpe \
#     --testpref ${BPE_DIR}/test.clean.bpe \
#     --bpe sentencepiece \
#     --destdir ${DATA_BIN} \
#     --joined-dictionary \
#     --workers 20
