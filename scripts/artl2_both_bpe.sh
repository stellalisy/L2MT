...
########################################################
KEY=artl2-both
rawfile_key='mixed-both'                                   # name identifier for raw data in the format "train.${rawfile_key}.en"
RAW_SOURCE='/home/sli136/l2mt/data/raw/'${KEY}             # raw (untokenized) data (artificial mixed data directory, doesn't include l2 and ref data)
