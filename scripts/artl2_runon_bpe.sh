...
########################################################
KEY=artl2-runon
rawfile_key='mixed-runon'                                  # name identifier for raw data in the format "train.${rawfile_key}.en"
RAW_SOURCE='/export/c11/sli136/l2mt/data/raw/'${KEY}             # raw (untokenized) data (artificial mixed data directory, doesn't include l2 and ref data)
