...
########################################################
KEY=all-mixed-lrg
rawfile_key='all-mixed-lrg'                                    # name identifier for raw data in the format "train.${rawfile_key}.en"
RAW_SOURCE='/home/sli136/l2mt/en-es/data/raw/'${rawfile_key}             # raw (untokenized) data (artificial mixed data directory, doesn't include l2 and ref data)
